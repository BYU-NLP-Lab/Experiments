...
def jobs(first_experiment, results_dir, topics_dir, mem):
    ...
    swept = broom.sweep(
        ...
        ('--basedir',(
            ...
            'data/newsgroups',
            'data/vectorgroups-d2v',
            'data/vectorgroups-w2v',
            'data/vectorgroups-lda',
            'data/vectorcfgroups-d2v-ann',
            'data/cfgroups1000',
            #'data/weather',
            #'data/weathextra',
            #'data/airlines',
        ...
        ('--dataset-type', broom.Mapper('--basedir',{
            ...
            'vectorgroups':'VECTORS',
            'vectorcfgroups':'JSON_VEC',
        ...
        ('--dataset', broom.Mapper('--basedir',{
            'cfgroups1000':'/aml/data/plf1/cfgroups/cfgroups1000.json',
            'vectorcfgroups-d2v-ann':'/aml/data/plf1/cfgroups/cfgroups1000.json',
            #'cfgroups1000':('cfgroups1000.json','derived/cfgroups1000notest.json','derived/cfgroups1000consensuslabels.json'),
            'weather':'/aml/data/plf1/weather/weather.json',
            'weathextra':('/aml/data/plf1/weathextra/weather-augmented.json','/aml/data/plf1/weathextra/weather-augmented-big.json'),
        ...
        ('--eval-point', broom.Mapper('--basedir',{
            ...
            'vectorgroups':parabolic_points(lowpoint,data_size['newsgroups']*depth,num_evalpoints),
            'ng':parabolic_points(lowpoint,data_size['newsgroups']*depth,num_evalpoints),
            'vectorcfgroups':parabolic_points(lowpoint,10000,num_evalpoints),
            'groups1000':parabolic_points(lowpoint,10000,num_evalpoints),
        ...
        ('--labeling-strategy',broom.Mapper('--basedir',{
            'vectorgroups': ('VARLOGRESP','DISCRIM'),
            'vectorcfgroups': ('VARLOGRESP','DISCRIM')
        },default=['UBASELINE','DISCRIM','VARMOMRESP','VARLOGRESP','LOGRESP','VARITEMRESP'], matchsubstrings=True).generator), 
        #},default=['UBASELINE','CSLDA','CSLDAP','CSLDALEX','DISCRIM','VARMOMRESP','VARLOGRESP','VARITEMRESP'], matchsubstrings=True).generator), 
        ...
        ('--training',broom.Mapper('--labeling-strategy',{
            ...
            'CSLDALEX':('sample-z-500:maximize-all','sample-z-500:sample-all-900:sample-all-100'),
        ...
        ('--b-theta',broom.Mapper('--labeling-strategy',{
            'CSLDA': 0.1,
        }, default=1.0, matchsubstrings=True).generator),
        ('--b-phi','0.1'),
        ('--b-mu','0.1'),
        ('--c-mu','1'),
        ('--c-gamma','1'),
        ...
        ('--b-gamma',broom.Mapper('--basedir',{
            ...
            'vectorgroups':(1.+2.)/(num_classes['newsgroups']+2.),
            'vectorcfgroups':(1.+2.)/(num_classes['newsgroups']+2.),
