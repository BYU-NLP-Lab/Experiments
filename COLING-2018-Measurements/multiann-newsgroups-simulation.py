...
# CUSTOMIZE this to point to your own COLING Experiments directory
EXPERIMENTS_DIR = "/home/plfelt/git/Experiments/COLING-2018-Measurements"
DATA_DIR = "%s/data" % EXPERIMENTS_DIR
